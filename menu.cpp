...
void menu::mainmenu(){
  ...
  while(keepgoing){
    ...
    else{std::cout<<"Your entry could not be unterstood, please enter an integer between 1 and 7\n";}
  }
...
void menu::distancemenu(){
  ...
  getline(std::cin,zip1);
  std::cin.clear();
  getline(std::cin,zip2);
  std::cin.clear();
